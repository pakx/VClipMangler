...
app.createView = function(mdl, acts)
    ...
    dlg:add_button("Update", h.btnClipUpdateClick, 3, row, 1)
    dlg:add_button("Add", h.btnClipAddClick, 4, row, 1)
    ...
    dlg:add_button("Select", h.btnClipSelectClick, 5, row, 1, 1)
        ...
        <div class="panel">
            ...
            <p><span class="secn">Miscellaneous notes</span>
                <ul>
                    ...
                    <li>Filter uses search text as a Lua-style regular expression; this could yield
                    surprises if it contains magic characters</li>
